...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative inset-y-0 z-10 hidden h-auto w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex justify-center gap-2 p-4", className)}
      {...props}
    />
  );
}
